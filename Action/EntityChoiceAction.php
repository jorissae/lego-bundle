...
final class EntityChoiceAction
{

    private $mem;
    private $security;

    public function __construct(AuthorizationCheckerInterface $security,MetaEntityManager $mem){
        $this->mem = $mem;
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $field = $this->mem->getField($entitySource, $request->get('fieldname'));
