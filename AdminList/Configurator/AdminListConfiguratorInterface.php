...
namespace Idk\LegoBundle\AdminList\Configurator;

use InvalidArgumentException;
use Idk\LegoBundle\AdminList\BulkAction\BulkActionInterface;
use Idk\LegoBundle\AdminList\ListAction\ListActionInterface;
use Idk\LegoBundle\AdminList\ItemAction\ItemActionInterface;
...
interface AdminListConfiguratorInterface
{
     ...
     * @return mixed
     */
    public function decorateNewEntity($entity,$request);
    ...
    /**
     * Return template to display after editing object.
     *
     * @return string
     */
